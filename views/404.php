...
<head>
  <title>My Memo</title>
  <link rel="stylesheet" type="text/css" href="<?= ROOT_PATH.'assets/css/404.css'?>">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="<?= ROOT_PATH.'memo' ?>">memmo</a></li>
        ...
        <div class="col-md-12">
            <div class="error-template">
                ...
                <div class="error-actions">
                    <a href="<?= ROOT_PATH.'home' ?>" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-home"></span>
